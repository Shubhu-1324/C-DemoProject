...
namespace UdemyCourseApi.Migrations.ProductHandlerDbMigrations
{
    ...
    [Migration("20241216180843_createProductImagesfolder1")]
    partial class createProductImagesfolder1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UdemyCourseApi.Models.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("119a5649-53eb-453c-8efd-a29617b74f98"),
                            Name = "Men"
                        },
                        new
                        {
                            Id = new Guid("6fd5d2ff-100e-4db5-862b-fcbdfe9612b3"),
                            Name = "Women"
                        },
                        new
                        {
                            Id = new Guid("861ef157-a112-47a1-b5b7-61a0f4615fa9"),
                            Name = "Child"
                        });
                });
